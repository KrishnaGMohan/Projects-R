...
# Calculate the volume of the donut based on the formula above and assign the result to vol_donut. You can use 
#    intermediary variables for this if you want.
